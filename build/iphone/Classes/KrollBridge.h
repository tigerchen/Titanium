...
@interface AROMAESPRESSOBARObject : KrollCoverageObject {
#else
@interface AROMAESPRESSOBARObject : KrollObject {
#endif
@private
...
extern NSString * AROMAESPRESSOBAR$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AROMAESPRESSOBARObject *_aromaespressobar;
    KrollObject* console;
	BOOL shutdown;
