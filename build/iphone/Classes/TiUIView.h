...
/**
 Base class for all AROMAESPRESSOBAR views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AROMAESPRESSOBAR view hierarchy (such as wrapped iOS UIViews) was touched.
