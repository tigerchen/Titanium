 ...
 * Copyright (c) 2009-2011 by AROMAESPRESSOBAR, Inc. All Rights Reserved.
...
//@interface AROMAESPRESSOBARObject : NSObject
//@end

@interface AROMAESPRESSOBARObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AROMAESPRESSOBARObject class]])
		{
			for (NSString *key in [[(AROMAESPRESSOBARObject*)o modules] allKeys])
			{
