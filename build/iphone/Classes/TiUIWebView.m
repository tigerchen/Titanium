...
static NSString * const kAROMAESPRESSOBARJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_aromaespressobarInjection
{
	...
	[html appendString:kAROMAESPRESSOBARJavascript];
...
{
	// attempt to make well-formed HTML and inject in our AROMAESPRESSOBAR bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _aromaespressobarInjection]];
