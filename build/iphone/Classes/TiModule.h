...
/**
 The base class for all AROMAESPRESSOBAR modules
 */
...
/**
 AROMAESPRESSOBAR Platform calls this method on startup.
 */
-(void)startup;

/**
 AROMAESPRESSOBAR Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AROMAESPRESSOBAR Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AROMAESPRESSOBAR Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AROMAESPRESSOBAR Platform calls this method on resume.
 @param sender The sender of the event.
 */
