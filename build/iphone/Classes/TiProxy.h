...
//Rare exceptions to indicate a bug in the _aromaespressobar code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AROMAESPRESSOBAR proxies.
 */
