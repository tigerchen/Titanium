...
// in simulator we redefine to format for AROMAESPRESSOBAR Developer console
...
{\
	NSString * exceptionName = [@"org.aromaespressobar." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.aromaespressobar";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAROMAESPRESSOBARNativeItemNone = -1, 
	UIAROMAESPRESSOBARNativeItemSpinner = -2,
	UIAROMAESPRESSOBARNativeItemProgressBar = -3,
	
	UIAROMAESPRESSOBARNativeItemSlider = -4,
	UIAROMAESPRESSOBARNativeItemSwitch = -5,
	UIAROMAESPRESSOBARNativeItemMultiButton = -6,
	UIAROMAESPRESSOBARNativeItemSegmented = -7,
	
	UIAROMAESPRESSOBARNativeItemTextView = -8,
	UIAROMAESPRESSOBARNativeItemTextField = -9,
	UIAROMAESPRESSOBARNativeItemSearchBar = -10,
	
	UIAROMAESPRESSOBARNativeItemPicker = -11,
	UIAROMAESPRESSOBARNativeItemDatePicker = -12,
	
	UIAROMAESPRESSOBARNativeItemInfoLight = -13,
	UIAROMAESPRESSOBARNativeItemInfoDark = -14,
	
	UIAROMAESPRESSOBARNativeItemDisclosure = -15,
	
	UIAROMAESPRESSOBARNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AROMAESPRESSOBAR instances of
