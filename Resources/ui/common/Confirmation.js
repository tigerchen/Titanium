function ConfirmationWindow(title) {
...
var vBody = Titanium.UI.createView({
	...
	height:'90%',
	width:'100%',
	backgroundImage:'/images/conf_bg.png'
});

var bSubmitted = Titanium.UI.createButton({
	center:{x:'50%',y:'60%'},
	backgroundImage: '/images/submitted.png',
	width: '63%',
	height: '12%'
});
vBody.add(bSubmitted);
